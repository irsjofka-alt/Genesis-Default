...
import gameserver.model.spawn.SpawnRange;
import gameserver.utils.PositionUtils;

public class Location implements IPositionable, SpawnRange
{
	private static final Logger _log = LogManager.getLogger(Location.class);
	
	private int _x;
	private int _y;
	private int _z;
	private int _heading;
	private boolean _isWasdMove = false;
	...
	public void setWasdMove(boolean val)
	{
		_isWasdMove = val;
	}
	
	public boolean isWasdMove()
	{
		return _isWasdMove;
	}
