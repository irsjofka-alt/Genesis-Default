 ...
 */
package gameserver.model.fishing;
...
public class Fish implements Cloneable
{
	...
	public Fish(int fishId, int itemId, String itemName, int fishGroup, int fishLevel, double fishBiteRate, double fishGuts, int fishHp, int fishMaxLength, double fishLengthRate, double hpRegen, int startCombatTime, int combatDuration, int gutsCheckTime, double gutsCheckProbability, double cheatingProb, int fishGrade)
	{
		_fishId = fishId;
		_itemId = itemId;
		_itemName = itemName;
	...
	public Fish clone()
	{
		return new Fish(_fishId, _itemId, _itemName, _fishGroup, _fishLevel, _fishBiteRate, _fishGuts, _fishHp, _fishMaxLength, _fishLengthRate, _hpRegen, _startCombatTime, _combatDuration, _gutsCheckTime, _gutsCheckProbability, _cheatingProb, _fishGrade);
	}
