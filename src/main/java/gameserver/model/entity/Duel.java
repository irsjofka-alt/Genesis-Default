...
import gameserver.network.serverpackets.ExDuelEnd;
import gameserver.network.serverpackets.ExDuelReady;
import gameserver.network.serverpackets.ExDuelStart;
...
public class Duel
{
	...
	public static class PlayerCondition
	{
		...
		public PlayerCondition(Player player, boolean partyDuel)
		{
			...
			final var effectList = player.getAllEffects();
