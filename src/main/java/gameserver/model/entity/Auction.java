...
{
	protected static final Logger _log = LogManager.getLogger(Auction.class);
	private int _id = 0;
	...
	public void endAuction()
	{
		if (ClanHallManager.getInstance().loaded())
		{
			...
			if (_sellerId > 0)
			{
				...
				returnItem(_sellerClanId, ClanHallManager.getInstance().getAuctionableHallById(_itemId).getRentPrice(), false);
			}
			deleteAuctionFromDB();
