...
import gameserver.network.serverpackets.ExBlockUpSetList;
import gameserver.network.serverpackets.ExBlockUpSetState;
import gameserver.network.serverpackets.RelationChanged;
import gameserver.network.serverpackets.SystemMessage;

public final class BlockCheckerEngine
{
	protected static final Logger _log = LogManager.getLogger(BlockCheckerEngine.class);
	...
	private class CarryingGirlUnspawn implements Runnable
	{
		...
		public void run()
		{
			...
			final var npc = _spawn.getLastSpawn();
			if (npc != null)
			{
				npc.deleteMe();
			}
