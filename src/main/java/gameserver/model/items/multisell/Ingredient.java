...
public class Ingredient
{
	...
	{
		this(set.getInteger("id"), set.getLong("count"), set.getDouble("chance", 100D), set.getInteger("enchantmentLevel", 0), set.getInteger("timeLimit", -1), generateAugmentation(set.getString("augmentation", null), set.getInteger("id")), generateElementals(set.getString("elementals", null), set.getInteger("id")), set.getBool("isTaxIngredient", false), set.getBool("maintainIngredient", false), set.getBool("validParameters", true), set.getInteger("minEnchant", 0), set.getInteger("maxEnchant", 0), set.getInteger("skillId", 0), set.getInteger("skillLevel", 0), set.getInteger("charLevel", 0));
	}
	
	public Ingredient(int itemId, long itemCount, double chance, int enchantmentLevel, int timeLimit, Augmentation augmentation, Elementals[] elementals, boolean isTaxIngredient, boolean maintainIngredient, boolean checkParams, int minEnchant, int maxEnchant, int skillId, int skillLevel, int charLevel)
	{
		_itemId = itemId;
	...
	{
		return new Ingredient(_itemId, _itemCount, _chance, _enchantmentLevel, _timeLimit, _augmentation, _elementals, _isTaxIngredient, _maintainIngredient, _isCheckParams, _minEnchant, _maxEnchant, _skillId, _skillLevel, _charLevel);
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + _enchantmentLevel;
	...
	public boolean equals(final Object obj)
	{
		...
		final var other = (Ingredient) obj;
		...
		if (_enchantmentLevel != other._enchantmentLevel)
		{
			return false;
		}
		return true;
