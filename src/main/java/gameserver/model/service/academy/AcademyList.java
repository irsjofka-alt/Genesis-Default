 ...
 */
package gameserver.model.service.academy;
...
import gameserver.network.serverpackets.JoinPledge;
...
{
	protected static final Logger _log = LogManager.getLogger(AcademyList.class);
