...
{
	private static final Logger _log = LogManager.getLogger(EffectTemplate.class);
	...
	public final int abnormalLvl;
	private int _cubicId = 0;

	public EffectTemplate(Condition attachCond, Condition applyCond, Lambda lambda, String pAbnormalType, int pAbnormalLvl, StatsSet set, StatsSet params)
	{
	...
	{
		return _name.startsWith("Cancel");
	}
}