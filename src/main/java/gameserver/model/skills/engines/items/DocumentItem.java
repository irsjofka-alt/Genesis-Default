 ...
 */
package gameserver.model.skills.engines.items;
...
import gameserver.model.base.ItemType;
import gameserver.model.holders.ItemHolder;
import gameserver.model.skills.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			final Constructor<?> c = Class.forName("gameserver.model.actor.templates.items." + _currentItem.type).getConstructor(StatsSet.class);
