 ...
 */
package gameserver.model.skills;
...
import gameserver.model.base.PlayerState;
...
import gameserver.model.skills.conditions.ConditionAgathionItemId;
import gameserver.model.skills.conditions.ConditionAngelCatEventActive;
import gameserver.model.skills.conditions.ConditionChangeWeapon;
import gameserver.model.skills.conditions.ConditionGameChance;
import gameserver.model.skills.conditions.ConditionGameTime;
import gameserver.model.skills.conditions.ConditionGameTime.CheckGameTime;
import gameserver.model.skills.conditions.ConditionLogicAnd;
import gameserver.model.skills.conditions.ConditionLogicNot;
import gameserver.model.skills.conditions.ConditionLogicOr;
import gameserver.model.skills.conditions.ConditionMinDistance;
import gameserver.model.skills.conditions.ConditionPeaceZone;
import gameserver.model.skills.conditions.ConditionPlayerActiveEffectId;
import gameserver.model.skills.conditions.ConditionPlayerActiveSkillId;
import gameserver.model.skills.conditions.ConditionPlayerAgathionId;
import gameserver.model.skills.conditions.ConditionPlayerCallPc;
import gameserver.model.skills.conditions.ConditionPlayerCanEscape;
import gameserver.model.skills.conditions.ConditionPlayerCanPossessHolything;
import gameserver.model.skills.conditions.ConditionPlayerCanRefuelAirship;
import gameserver.model.skills.conditions.ConditionPlayerCanSummon;
import gameserver.model.skills.conditions.ConditionPlayerCanSummonSiegeGolem;
import gameserver.model.skills.conditions.ConditionPlayerCanSweep;
import gameserver.model.skills.conditions.ConditionPlayerCanTakePcBangPoints;
import gameserver.model.skills.conditions.ConditionPlayerCanTransform;
import gameserver.model.skills.conditions.ConditionPlayerCanUntransform;
import gameserver.model.skills.conditions.ConditionPlayerCharges;
import gameserver.model.skills.conditions.ConditionPlayerClassIdRestriction;
import gameserver.model.skills.conditions.ConditionPlayerCloakStatus;
import gameserver.model.skills.conditions.ConditionPlayerCombat;
import gameserver.model.skills.conditions.ConditionPlayerCp;
import gameserver.model.skills.conditions.ConditionPlayerDualDagger;
import gameserver.model.skills.conditions.ConditionPlayerEnergy;
import gameserver.model.skills.conditions.ConditionPlayerFlyMounted;
import gameserver.model.skills.conditions.ConditionPlayerGrade;
import gameserver.model.skills.conditions.ConditionPlayerHasCastle;
import gameserver.model.skills.conditions.ConditionPlayerHasClanHall;
import gameserver.model.skills.conditions.ConditionPlayerHasFort;
import gameserver.model.skills.conditions.ConditionPlayerHasPet;
import gameserver.model.skills.conditions.ConditionPlayerHasServitor;
import gameserver.model.skills.conditions.ConditionPlayerHp;
import gameserver.model.skills.conditions.ConditionPlayerInFightEvent;
import gameserver.model.skills.conditions.ConditionPlayerInsideZoneId;
import gameserver.model.skills.conditions.ConditionPlayerInstanceId;
import gameserver.model.skills.conditions.ConditionPlayerInvSize;
import gameserver.model.skills.conditions.ConditionPlayerIsClanLeader;
import gameserver.model.skills.conditions.ConditionPlayerIsHero;
import gameserver.model.skills.conditions.ConditionPlayerLandingZone;
import gameserver.model.skills.conditions.ConditionPlayerLevel;
import gameserver.model.skills.conditions.ConditionPlayerLevelRange;
import gameserver.model.skills.conditions.ConditionPlayerMountedType;
import gameserver.model.skills.conditions.ConditionPlayerMp;
import gameserver.model.skills.conditions.ConditionPlayerPkCount;
import gameserver.model.skills.conditions.ConditionPlayerPledgeClass;
import gameserver.model.skills.conditions.ConditionPlayerRace;
import gameserver.model.skills.conditions.ConditionPlayerRangeFromNpc;
import gameserver.model.skills.conditions.ConditionPlayerReflectionEntry;
import gameserver.model.skills.conditions.ConditionPlayerServitorNpcId;
import gameserver.model.skills.conditions.ConditionPlayerSex;
import gameserver.model.skills.conditions.ConditionPlayerSiegeSide;
import gameserver.model.skills.conditions.ConditionPlayerSouls;
import gameserver.model.skills.conditions.ConditionPlayerState;
import gameserver.model.skills.conditions.ConditionPlayerSubclass;
import gameserver.model.skills.conditions.ConditionPlayerTransformationId;
import gameserver.model.skills.conditions.ConditionPlayerVehicleMounted;
import gameserver.model.skills.conditions.ConditionPlayerWeight;
import gameserver.model.skills.conditions.ConditionSiegeZone;
import gameserver.model.skills.conditions.ConditionSlotItemId;
import gameserver.model.skills.conditions.ConditionTargetAbnormal;
import gameserver.model.skills.conditions.ConditionTargetActiveEffectId;
import gameserver.model.skills.conditions.ConditionTargetActiveSkillId;
import gameserver.model.skills.conditions.ConditionTargetAggro;
import gameserver.model.skills.conditions.ConditionTargetClassIdRestriction;
import gameserver.model.skills.conditions.ConditionTargetInvSize;
import gameserver.model.skills.conditions.ConditionTargetLevel;
import gameserver.model.skills.conditions.ConditionTargetLevelRange;
import gameserver.model.skills.conditions.ConditionTargetMyPartyExceptMe;
import gameserver.model.skills.conditions.ConditionTargetNpcId;
import gameserver.model.skills.conditions.ConditionTargetNpcType;
import gameserver.model.skills.conditions.ConditionTargetPercentCp;
import gameserver.model.skills.conditions.ConditionTargetPercentHp;
import gameserver.model.skills.conditions.ConditionTargetPercentMp;
import gameserver.model.skills.conditions.ConditionTargetPlayable;
import gameserver.model.skills.conditions.ConditionTargetRace;
import gameserver.model.skills.conditions.ConditionTargetRaceId;
import gameserver.model.skills.conditions.ConditionTargetUsesWeaponKind;
import gameserver.model.skills.conditions.ConditionTargetWard;
import gameserver.model.skills.conditions.ConditionTargetWeight;
import gameserver.model.skills.conditions.ConditionUsingItemType;
import gameserver.model.skills.conditions.ConditionUsingSkill;
import gameserver.model.skills.conditions.ConditionWithSkill;
...
import gameserver.model.skills.funcs.LambdaCalc;
import gameserver.model.skills.funcs.LambdaConst;
import gameserver.model.skills.funcs.LambdaStats;
...
public abstract class DocumentBase
{
	...
	protected Condition parsePlayerCondition(Node n, Object template)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			else if ("party".equalsIgnoreCase(a.getNodeName()))
			{
				final boolean val = Boolean.parseBoolean(a.getNodeValue());
				cond = joinAnd(cond, new ConditionPlayerState(PlayerState.PARTY, val, new ArrayList<>()));
			}
			...
			else if ("isMountType".equalsIgnoreCase(a.getNodeName()))
			{
				cond = joinAnd(cond, new ConditionPlayerMountedType(Enum.valueOf(MountType.class, a.getNodeValue())));
			}
		}
