...
import gameserver.model.actor.stat.PlayableStat;
import gameserver.model.actor.status.PlayableStatus;
...
public abstract class Playable extends Creature
{
	...
	protected void onDeath(Creature killer)
	{
		...
		if (isPhoenixBlessed())
		{
			...
			{
				stopEffects(EffectType.CHARM_OF_LUCK, true);
			}
			if (isNoblesseBlessed())
			{
				stopEffects(EffectType.NOBLESSE_BLESSING, true);
			}
		}
	...
	{
		final var weapon = getActiveWeaponItem();
		if (weapon != null)
		{
