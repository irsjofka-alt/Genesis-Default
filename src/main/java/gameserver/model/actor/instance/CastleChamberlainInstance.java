...
import gameserver.model.actor.templates.TeleportTemplate;
...
import gameserver.network.serverpackets.ExShowDominionRegistry;
			...
			else if (actualCommand.equalsIgnoreCase("manage"))
			{
				if ((player.getClanPrivileges() & Clan.CP_CS_SET_FUNCTIONS) == Clan.CP_CS_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, player.getLang(), "data/html/chamberlain/edit_recovery.htm", false);
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, player.getLang(), "data/html/chamberlain/edit_other.htm", false);
