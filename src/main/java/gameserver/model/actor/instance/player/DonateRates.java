...
import gameserver.data.dao.DonateRatesDAO;
import gameserver.model.actor.Player;
import gameserver.model.actor.templates.player.DonateRateTempate;
...
public class DonateRates extends LoggerObject
{
	...
	public void recalcTime()
	{
		...
		final var sorted = _donateList.entrySet().stream().sorted(Map.Entry.comparingByValue()).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, _) -> e1, LinkedHashMap::new));
		if (!sorted.isEmpty())
		{
