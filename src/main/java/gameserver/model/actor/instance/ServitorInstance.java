...
public class ServitorInstance extends Summon
{
	...
	public int getEvasionRate(Creature target)
	{
		...
		return (int) (super.getEvasionRate(target) + bonus > 1. ? (getOwner().getEvasionRate(target) + bonus) : 0);
	}
	...
	public int getAccuracy()
	{
		...
		return (int) (super.getAccuracy() + bonus > 1. ? (getOwner().getAccuracy() + bonus) : 0);
	}
