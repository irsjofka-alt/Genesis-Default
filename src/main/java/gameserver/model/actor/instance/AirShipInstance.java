...
import gameserver.ai.character.AirShipAI;
import gameserver.instancemanager.AirShipManager;
import gameserver.instancemanager.ReflectionManager;
import gameserver.model.Location;
import gameserver.model.actor.Player;
import gameserver.model.actor.Vehicle;
import gameserver.model.actor.templates.character.CharTemplate;
import gameserver.network.serverpackets.ExAirShipInfo;
import gameserver.network.serverpackets.ExGetOffAirShip;
import gameserver.network.serverpackets.ExGetOnAirShip;
import gameserver.network.serverpackets.ExMoveToLocationAirShip;
import gameserver.network.serverpackets.ExStopMoveAirShip;
