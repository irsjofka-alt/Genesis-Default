 ...
 */
package gameserver.model.actor.stat;
...
import gameserver.model.stats.MoveType;
...
public class CharStat
{
	...
	public double getRunSpeed()
	{
		...
		if (_activeChar.isSummon())
		{
			...
			if (_activeChar.isServitor())
			{
				final double speed = owner != null ? (owner.getRunSpeed() * (owner.getServitorShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseRunSpd * bonus + speed));
			}
			else
			{
				...
				final double speed = owner != null ? (owner.getRunSpeed() * (owner.getPetShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseRunSpd * bonus + speed));
			}
		}
	...
	public double getWalkSpeed()
	{
		...
		if (_activeChar.isSummon())
		{
			...
			if (_activeChar.isServitor())
			{
				final double walk = owner != null ? (owner.getWalkSpeed() * (owner.getServitorShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseWalkSpd * bonus + walk));
			}
			else
			{
				if (_activeChar.isPet())
				...
				final double walk = owner != null ? (owner.getWalkSpeed() * (owner.getPetShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseWalkSpd * bonus + walk));
			}
		}
	...
	public double getSwimRunSpeed()
	{
		...
		if (_activeChar.isSummon())
		{
			...
			if (_activeChar.isServitor())
			{
				final double swimRun = owner != null ? (owner.getSwimRunSpeed() * (owner.getServitorShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseRunSpd + swimRun));
			}
			else
			{
				final double swimRun = owner != null ? (owner.getSwimRunSpeed() * (owner.getPetShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseRunSpd + swimRun));
			}
		}
	...
	public double getSwimWalkSpeed()
	{
		...
		if (_activeChar.isSummon())
		{
			...
			if (_activeChar.isServitor())
			{
				final double swimWalk = owner != null ? (owner.getSwimWalkSpeed() * (owner.getServitorShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseWalkSpd + swimWalk));
			}
			else
			{
				final double swimWalk = owner != null ? (owner.getSwimWalkSpeed() * (owner.getPetShareBonus(Stats.MOVE_SPEED) - 1.0)) : 0;
				return calcStat(Stats.MOVE_SPEED, (baseWalkSpd + swimWalk));
			}
		}
	...
	public final double getPAtkValakas(Creature target)
	{
		return calcStat(Stats.VALAKAS_PROF, 1, target, null);
	}
	
	public final double getPDefValakas(Creature target)
	{
		return calcStat(Stats.VALAKAS_VULN, 1, target, null);
	}
