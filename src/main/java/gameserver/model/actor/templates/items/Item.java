 ...
 */
package gameserver.model.actor.templates.items;
...
import gameserver.model.skills.conditions.ConditionPetType;
...
{
	protected static final Logger _log = LogManager.getLogger(Item.class);
	...
	{
		return Config.ALLOW_BLOCK_SELL_ITEMS ? false : _sellable;
	}
	
	public final boolean isDropable()
	{
		return Config.ALLOW_BLOCK_DROP_ITEMS ? false : _dropable;
	}
	
	public final boolean isDestroyable()
	{
		return Config.ALLOW_BLOCK_DESTROY_ITEMS ? false : _destroyable;
	}
	
	public final boolean isTradeable()
	{
		return Config.ALLOW_BLOCK_TRADE_ITEMS ? false : _tradeable;
	}
	
	public final boolean isDepositable()
	{
		return Config.ALLOW_BLOCK_DEPOSIT_ITEMS ? false : _depositable;
	}
	
	public boolean isEnchantable()
	{
		return ArrayUtils.contains(Config.ENCHANT_BLACKLIST, getId()) ? false : _enchantable > 0;
	}
	
	public final boolean isElementable()
	{
		return _elementBlackList || _heroItem ? false : Config.ENCHANT_ELEMENT_ALL_ITEMS ? ((isArmor() || isWeapon()) && getCrystalType() >= Item.CRYSTAL_S && getBodyPart() != Item.SLOT_L_HAND) : _elementable;
	}
	...
	public boolean isPetItems()
	{
		return isConditionAttached() || getHandlerName() != null && getHandlerName().equals("PetFood");
	}
}