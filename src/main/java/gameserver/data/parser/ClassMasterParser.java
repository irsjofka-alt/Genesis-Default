...
public final class ClassMasterParser extends DocumentParser
{
	...
	private final Map<Integer, List<ItemHolder>> _classChangeRewards = new HashMap<>();
			...
			if ("list".equals(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					...
					else if ("grandMaster".equals(d.getNodeName()))
					{
						...
						_classChangeRewards.put(level, items);
					}
				}
			}
		}
	...
	{
		return _classChangeRewards.get(level);
	}
