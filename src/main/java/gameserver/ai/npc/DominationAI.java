...
import gameserver.model.actor.instance.DominationInstance;
import gameserver.model.entity.events.AbstractFightEvent.EVENT_STATE;
...
public class DominationAI extends CharacterAI implements Runnable
{
	...
	protected boolean thinkActive()
	{
		...
		try
		{
			targets = World.getAroundCharacters(actor, 300, 300);
