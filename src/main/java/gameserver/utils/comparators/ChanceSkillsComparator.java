...
public class ChanceSkillsComparator implements Comparator<Options>
{
	private static final ChanceSkillsComparator instance = new ChanceSkillsComparator();

	public static final ChanceSkillsComparator getInstance()
	{
		return instance;
	}
