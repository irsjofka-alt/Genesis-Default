...
public class SkillTypeComparator implements Comparator<SkillChangeType>
{
	private static final SkillTypeComparator instance = new SkillTypeComparator();

	public static final SkillTypeComparator getInstance()
	{
		return instance;
	}
