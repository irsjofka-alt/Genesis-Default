...
public class ActiveSkillsComparator implements Comparator<Options>
{
	private static final ActiveSkillsComparator instance = new ActiveSkillsComparator();

	public static final ActiveSkillsComparator getInstance()
	{
		return instance;
	}
