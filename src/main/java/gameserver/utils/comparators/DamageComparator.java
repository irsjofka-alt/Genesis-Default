...
public class DamageComparator implements Comparator<DamageInfo>
{
	private static final DamageComparator instance = new DamageComparator();

	public static final DamageComparator getInstance()
	{
		return instance;
	}
