...
import gameserver.network.clientpackets.*;
import gameserver.network.clientpackets.Interface.RequestDynamicPacket;
import gameserver.network.clientpackets.pledge.RequestAnswerJoinPledge;
import gameserver.network.clientpackets.pledge.RequestCreatePledge;
import gameserver.network.clientpackets.pledge.RequestDismissPledge;
import gameserver.network.clientpackets.pledge.RequestExPledgeCrestLarge;
import gameserver.network.clientpackets.pledge.RequestExSetPledgeCrestLarge;
import gameserver.network.clientpackets.pledge.RequestJoinPledge;
import gameserver.network.clientpackets.pledge.RequestOustPledgeMember;
import gameserver.network.clientpackets.pledge.RequestPledgeCrest;
import gameserver.network.clientpackets.pledge.RequestPledgeExtendedInfo;
import gameserver.network.clientpackets.pledge.RequestPledgeInfo;
import gameserver.network.clientpackets.pledge.RequestPledgeMemberInfo;
import gameserver.network.clientpackets.pledge.RequestPledgeMemberList;
import gameserver.network.clientpackets.pledge.RequestPledgeMemberPowerInfo;
import gameserver.network.clientpackets.pledge.RequestPledgePower;
import gameserver.network.clientpackets.pledge.RequestPledgePowerGradeList;
import gameserver.network.clientpackets.pledge.RequestPledgeReorganizeMember;
import gameserver.network.clientpackets.pledge.RequestPledgeSetAcademyMaster;
import gameserver.network.clientpackets.pledge.RequestPledgeSetMemberPowerGrade;
import gameserver.network.clientpackets.pledge.RequestPledgeWarList;
import gameserver.network.clientpackets.pledge.RequestReplyStartPledgeWar;
import gameserver.network.clientpackets.pledge.RequestReplyStopPledgeWar;
import gameserver.network.clientpackets.pledge.RequestReplySurrenderPledgeWar;
import gameserver.network.clientpackets.pledge.RequestSurrenderPledgeWar;
import gameserver.network.clientpackets.pledge.RequestWithDrawalPledge;
...
{
	private static final Logger _log = LogManager.getLogger(GamePacketHandler.class);
