...
import gameserver.network.communication.gameserverpackets.OnlineStatus;
...
public class AuthResponse extends ReceivablePacket
{
	...
	protected void runImpl()
	{
		...
		AuthServerCommunication.getInstance().getAccounts().forEach(a -> sendPacket(new PlayerInGame(a)));
	}
}