...
import gameserver.model.actor.instance.BabyPetInstance;
...
import gameserver.network.serverpackets.ExAskCoupleAction;
import gameserver.network.serverpackets.ExBasicActionList;
import gameserver.network.serverpackets.NpcSay;
import gameserver.network.serverpackets.RecipeShopManageList;
...
public final class RequestActionUse extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		switch (_actionId)
		{
			...
			case 7 :
				...
				for (final Creature cha : World.getAroundCharacters(activeChar, 400, 200))
				{
	...
	protected boolean useSit(Player activeChar, GameObject target)
	{
		...
		{
			activeChar.stopEffects(EffectType.FAKE_DEATH, true);
		}
