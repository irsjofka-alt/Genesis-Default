...
public final class RequestRestartPoint extends GameClientPacket
{
	...
	protected final void portPlayer(final Player activeChar)
	{
		...
		switch (_requestedPointType)
		{
			...
			case 5 :
				final var item = activeChar.getInventory().getSelfResurrection();
				if (item != null && activeChar.getInventory().destroyItemByObjectId(item.getObjectId(), 1, activeChar, true) != null)
				{
					activeChar.doRevive();
					return;
				}
