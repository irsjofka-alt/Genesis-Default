...
import gameserver.network.serverpackets.TradeRequest;
...
public final class RequestTrade extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((partner == null) || !player.isInNeighboringRegion(partner) || ((partner.getReflectionId() != player.getReflectionId())))
		{
			return;
		}
