...
import gameserver.network.serverpackets.TradeOtherAdd;
import gameserver.network.serverpackets.TradeOwnAdd;
import gameserver.network.serverpackets.TradeUpdate;
...
public final class RequestAddTradeItem extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		final TradeItem item = trade.addItem(_objectId, _count, true);
		if (item != null)
		{
