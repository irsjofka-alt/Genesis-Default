...
import gameserver.model.actor.templates.SeedTemplate;
...
public class RequestBuySeed extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		for (final ItemHolder i : _items)
		{
			...
			Log.addLogItem(getClass().getSimpleName(), player.getName(null) + " -> buy ->", Util.getItemName(i.getId()), i.getCount(), 0, "-> by " + manager.getName(null));
		}
