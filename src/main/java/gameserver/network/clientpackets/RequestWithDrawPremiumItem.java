...
import gameserver.network.serverpackets.ExGetPremiumItemList;
...
public final class RequestWithDrawPremiumItem extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		Log.addLogItem(getClass().getSimpleName(), activeChar.getName(null) + " -> receive premiumItem ->", Util.getItemName(_item.getId()), _itemCount, 0, null);
	}
}