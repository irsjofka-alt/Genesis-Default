...
import gameserver.instancemanager.tasks.MessageDeletionTask;
...
import gameserver.utils.comparators.MailComparator;
...
public final class MailManager extends LoggerObject
{
	...
	public final List<Message> getInbox(int objectId)
	{
		...
		{
			Collections.sort(inbox, new MailComparator(false));
		}
		return inbox;
	}
	...
	public final List<Message> getOutbox(int objectId)
	{
		...
		{
			Collections.sort(outbox, new MailComparator(true));
		}
		return outbox;
	}
