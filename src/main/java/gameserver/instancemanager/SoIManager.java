...
public class SoIManager extends LoggerObject
{
	...
	{
		SpawnParser.getInstance().despawnGroup("soi_world_closedmouths", "soi_world_mouths", "soi_world_abyssgaze2", "soi_world_abyssgaze1");
		
		switch (getCurrentStage())
		{
			case 1 :
			case 4 :
				SpawnParser.getInstance().spawnGroup("soi_world_mouths", "soi_world_abyssgaze2");
				break;
			case 5 :
				SpawnParser.getInstance().spawnGroup("soi_world_closedmouths", "soi_world_abyssgaze2");
				break;
			default :
				SpawnParser.getInstance().spawnGroup("soi_world_closedmouths", "soi_world_abyssgaze1");
				break;
		}
	}
	...
	{
		SpawnParser.getInstance().spawnGroup("soi_hos_middle_seeds", "soi_hoe_middle_seeds", "soi_hoi_middle_seeds", "soi_all_middle_stable_tumor");
	}
