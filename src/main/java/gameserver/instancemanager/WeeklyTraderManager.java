							...
							if ("item".equalsIgnoreCase(item.getNodeName()))
							{
								...
								for (Node ing = item.getFirstChild(); ing != null; ing = ing.getNextSibling())
								{
									if ("production".equalsIgnoreCase(ing.getNodeName()))
									{
										...
										final Ingredient i = new Ingredient(id, count, 100, 0, -1, null, null, false, false, false, 0, 0, 0, 0, 0);
									...
									else if ("ingredient".equalsIgnoreCase(ing.getNodeName()))
									{
										...
										final Ingredient i = new Ingredient(id, Rnd.get(min, max), 100, 0, -1, null, null, false, false, false, 0, 0, 0, 0, 0);
			...
			try (ResultSet rset = ps.executeQuery())
			{
				...
				while (rset.next())
				{
					...
					for (final String product : productSplit)
					{
						...
						e.addProduct(new Ingredient(id, count, 100, 0, -1, null, null, false, false, false, 0, 0, 0, 0, 0));
					}
					...
					for (final String ingredient : ingredintSplit)
					{
						...
						e.addIngredient(new Ingredient(id, count, 100, 0, -1, null, null, false, false, false, 0, 0, 0, 0, 0));
					}
					_selectedEntries.add(e);
				}
			}
