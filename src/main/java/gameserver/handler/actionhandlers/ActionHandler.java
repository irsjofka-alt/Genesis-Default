 ...
 */
package gameserver.handler.actionhandlers;

import java.util.HashMap;
import java.util.Map;

import l2e.commons.log.LoggerObject;
import gameserver.handler.actionhandlers.impl.ArtefactAction;
import gameserver.handler.actionhandlers.impl.DecoyAction;
import gameserver.handler.actionhandlers.impl.DoorAction;
import gameserver.handler.actionhandlers.impl.ItemAction;
import gameserver.handler.actionhandlers.impl.NpcAction;
import gameserver.handler.actionhandlers.impl.PetAction;
import gameserver.handler.actionhandlers.impl.PlayerAction;
import gameserver.handler.actionhandlers.impl.StaticObjectAction;
import gameserver.handler.actionhandlers.impl.SummonAction;
import gameserver.handler.actionhandlers.impl.TrapAction;
