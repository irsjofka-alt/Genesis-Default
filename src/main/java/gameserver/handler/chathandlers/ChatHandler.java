 ...
 */
package gameserver.handler.chathandlers;

import java.util.HashMap;
import java.util.Map;

import l2e.commons.log.LoggerObject;
import gameserver.handler.chathandlers.impl.ChatAll;
import gameserver.handler.chathandlers.impl.ChatAlliance;
import gameserver.handler.chathandlers.impl.ChatBattlefield;
import gameserver.handler.chathandlers.impl.ChatClan;
import gameserver.handler.chathandlers.impl.ChatHeroVoice;
import gameserver.handler.chathandlers.impl.ChatMpccRoom;
import gameserver.handler.chathandlers.impl.ChatParty;
import gameserver.handler.chathandlers.impl.ChatPartyMatchRoom;
import gameserver.handler.chathandlers.impl.ChatPartyRoomAll;
import gameserver.handler.chathandlers.impl.ChatPartyRoomCommander;
import gameserver.handler.chathandlers.impl.ChatPetition;
import gameserver.handler.chathandlers.impl.ChatShout;
import gameserver.handler.chathandlers.impl.ChatTell;
import gameserver.handler.chathandlers.impl.ChatTrade;
