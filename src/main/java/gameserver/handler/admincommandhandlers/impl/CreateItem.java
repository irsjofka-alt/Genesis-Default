...
public class CreateItem implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
		...
		else if (command.startsWith("admin_give_item_to_all"))
		{
			...
			Log.addLogItem("AdminCreate", activeChar.getName(null) + " -> create ->", template.getName(null), numval, 0, "-> to all online players.");
		...
		else if (command.startsWith("admin_give_item_all_with_check"))
		{
			...
			Log.addLogItem("AdminCreate", activeChar.getName(null) + " -> create ->", template.getName(null), numval, 0, "-> to all hwids.");
			activeChar.sendMessage(counter + " players rewarded with " + template.getName(activeChar.getLang()));
			hwids.clear();
		}
		return true;
	...
	private void createItem(Player activeChar, Player target, int id, long num)
	{
		...
		Log.addLogItem("AdminCreate", activeChar.getName(null) + " -> create ->", template.getName(null), num, 0, "-> to " + target.getName(null));
