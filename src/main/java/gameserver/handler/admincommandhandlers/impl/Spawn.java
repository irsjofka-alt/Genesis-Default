...
public class Spawn implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
		...
		else if (command.equalsIgnoreCase("admin_change_sign"))
		{
			SevenSigns.getInstance().changePeriod();
			activeChar.sendMessage("Seven Signs status changes!");
		}
