...
public class EditNpc implements IAdminCommandHandler
{
	...
	protected void showNpcInfoList(Player player, Npc npc)
	{
		...
		html.replace("%aggro%", String.valueOf((npc instanceof Attackable) ? npc.getAggroRange() : 0));
		...
		html.replace("%region%", npc.getWorldRegion() != null ? npc.getWorldRegion().toString() : "<font color=FF0000>null</font>");
