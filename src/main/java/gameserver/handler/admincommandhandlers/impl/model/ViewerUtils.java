 ...
 */
package gameserver.handler.admincommandhandlers.impl.model;
...
import gameserver.handler.communityhandlers.impl.AbstractCommunity;
import gameserver.model.actor.Player;

public class ViewerUtils
{
	private static final Logger _log = LogManager.getLogger(ViewerUtils.class);
