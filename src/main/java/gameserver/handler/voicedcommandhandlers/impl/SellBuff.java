									...
									if (activeChar.hasSummon() && Config.ALLOW_SELLBUFFS_PETS)
									{
										...
										for (final EffectTemplate et : s.getEffectTemplates())
										{
											...
											if (eff != null)
											{
												...
												eff.scheduleEffect(true, false);
											}
										}
										activeChar.getSummon().updateEffectIcons();
									}
								}
								else
								{
									s.getEffects(seller, activeChar, false, true);
									if (activeChar.hasSummon() && Config.ALLOW_SELLBUFFS_PETS)
									{
										s.getEffects(seller, activeChar.getSummon(), false, true);
									}
								}
