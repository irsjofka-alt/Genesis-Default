...
public class NpcActionShift implements IActionHandler
{
	...
	public boolean action(Player activeChar, GameObject target, boolean interact, boolean shift)
	{
		...
		if (activeChar.getAccessLevel().allowNpcActionShift())
		{
			...
			html.replace("%region%", target.getWorldRegion() != null ? target.getWorldRegion().toString() : "<font color=FF0000>null</font>");
			...
			final var ai = ((Npc) target).getAI();
			if (ai != null)
			{
				html.replace("%ai_intention%", "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Intention:</font></td><td align=right width=170>" + String.valueOf(ai.getIntention().name()) + "</td></tr></table></td></tr>");
		...
		else if (Config.ALT_GAME_VIEWNPC)
		{
			...
			else
			{
				...
				{
					html.replace("%ai_intention%", "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Intention:</font></td><td align=right width=170>" + String.valueOf(ai.getIntention().name()) + "</td></tr></table></td></tr>");
					html.replace("%ai%", "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>AI</font></td><td align=right width=170>" + ai.getClass().getSimpleName() + "</td></tr></table></td></tr>");
