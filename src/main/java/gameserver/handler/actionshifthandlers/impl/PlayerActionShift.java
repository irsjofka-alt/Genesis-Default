...
public class PlayerActionShift implements IActionHandler
{
	...
	public boolean action(Player activeChar, GameObject target, boolean interact, boolean shift)
	{
		...
		else if (Config.ALT_GAME_VIEWPLAYER)
		{
			...
			selectInfo.replace("%patk%", String.valueOf((int) ((Player) target).getPAtk(null)));
			selectInfo.replace("%matk%", String.valueOf((int) ((Player) target).getMAtk(null, null)));
			selectInfo.replace("%pdef%", String.valueOf((int) ((Player) target).getPDef(null)));
			selectInfo.replace("%mdef%", String.valueOf((int) ((Player) target).getMDef(null, null)));
			...
			selectInfo.replace("%patkspd%", String.valueOf((int) ((Player) target).getPAtkSpd()));
			selectInfo.replace("%matkspd%", String.valueOf((int) ((Player) target).getMAtkSpd()));
