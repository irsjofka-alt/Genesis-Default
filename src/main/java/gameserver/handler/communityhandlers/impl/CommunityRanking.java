...
import gameserver.model.actor.templates.community.CharPointsInfo;
import gameserver.model.actor.templates.community.ClanPointsInfo;
import gameserver.model.strings.server.ServerStorage;
import gameserver.utils.TimeUtils;
import gameserver.utils.Util;
import gameserver.utils.comparators.CharPointsComparator;
import gameserver.utils.comparators.ClanPointComparator;
...
public class CommunityRanking extends AbstractCommunity implements ICommunityBoardHandler
{
	...
	private void selectRankingRaidPoints()
	{
		...
		Collections.sort(charPointList, CharPointsComparator.getInstance());
	...
	private void selectRankingClanRaidPoints()
	{
		...
		Collections.sort(clanPointList, ClanPointComparator.getInstance());
