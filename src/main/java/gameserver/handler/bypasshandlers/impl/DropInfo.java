...
import gameserver.model.reward.CalculateRewardChances.GroupInfoTemplate;
...
import gameserver.utils.comparators.GroupInfoComparator;
import gameserver.utils.comparators.QuestComparator;
import gameserver.utils.comparators.SkillInfoComparator;
			...
			switch (actualCommand.toLowerCase())
			{
				...
				case "skills" :
				{
					 try
					 {
						...
						final var skillList = tpl.getSkills().values().stream().collect(Collectors.toList());
						...
						Collections.sort(skillList, SkillInfoComparator.getInstance());
				...
				case "quests" :
				{
					try
					{
						...
						if (npc != null)
						{
							...
							Collections.sort(questList, QuestComparator.getInstance());
				...
				case "drop" :
				{
					try
					{
						...
						Collections.sort(allItems, DropComparator.getInstance());
				...
				case "group" :
				{
					try
					{
						...
						Collections.sort(allItems, GroupInfoComparator.getInstance());
