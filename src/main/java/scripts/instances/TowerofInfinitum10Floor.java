...
{
	public TowerofInfinitum10Floor()
	{
		super(143);
	...
	{
		enterReflection(player, npc, 143);
	}
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		if (isInReflection(r))
		{
			r.setReturnLoc(new Location(-19008, 277122, -13376));
			finishInstance(r, true);
			addSpawn(32374, -19056, 278732, -15040, 0, false, 0, false, r);
		}
