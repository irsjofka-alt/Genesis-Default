...
public class _714_PathToBecomingALordSchuttgart extends Quest
{
	...
	private _714_PathToBecomingALordSchuttgart()
	{
		super(714);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		final var castle = CastleManager.getInstance().getCastleById(9);
		switch (event)
		{
			case "35555-02.htm":
			case "35555-06.htm" :
			...
			case "35555-13.htm" :
			{
				if (st.isCond(7))
				{
					...
					final var fort = FortManager.getInstance().getFort(111);
					if (fort != null)
					{
						...
						else if (fort.getContractedCastleId() != 9)
						{
							return "35555-12b.htm";
						}
					}
					final var packet = new NpcSay(npc.getObjectId(), Say2.NPC_SHOUT, npc.getId(), NpcStringId.S1_HAS_BECOME_THE_LORD_OF_THE_TOWN_OF_SCHUTTGART_MAY_THERE_BE_GLORY_IN_THE_TERRITORY_OF_SCHUTTGART);
			...
			case 31961 :
			{
				switch (st.getCond())
				{
					...
					case 3:
					{
						...
						qs1 = talker.getQuestState("_114_ResurrectionOfAnOldManager");
						var qs2 = getQuestState(talker, false);
						qs2 = talker.getQuestState("_120_PavelsResearch");
						var qs3 = getQuestState(talker, false);
						qs3 = talker.getQuestState("_121_PavelTheGiant");
	...
	{
		final var st = getRandomPartyMemberState(killer, 5, 3, npc);
		if (st != null)
		{
