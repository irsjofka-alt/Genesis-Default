...
public class _218_TestimonyOfLife extends Quest
{
	...
	private static final int[] MOBS =
        	{
	        HARPY, WYRM, MARSH_SPIDER, UNICORN_OF_EVA, GUARDIAN_BASILISK, LETO_LIZARDMAN_SHAMAN, LETO_LIZARDMAN_OVERLORD, ANT_RECRUIT, ANT_PATROL, ANT_GUARD, ANT_SOLDIER, ANT_WARRIOR_CAPTAIN
	};
	...
	private static final int[] QUESTITEMS =
        	{
	        CAMOMILE_CHARM, CARDIENS_LETTER, WATER_OF_LIFE, MOONFLOWER_CHARM, HIERARCHS_LETTER, STARDUST, PURE_MITHRIL_CUP, THALIAS_INSTRUCTIONS, ISAELS_LETTER, TEARS_OF_UNICORN, GRAIL_DIAGRAM, PUSHKINS_LIST, THALIAS_LETTER1, ARKENIAS_CONTRACT, ANDARIEL_SCRIPTURE_COPY, ARKENIAS_INSTRUCTIONS, ADONIUS_LIST, THALIAS_LETTER2, TALINS_SPEAR_BLADE, TALINS_SPEAR_SHAFT, TALINS_RUBY, TALINS_AQUAMARINE, TALINS_AMETHYST, TALINS_PERIDOT, ISAELS_INSTRUCTIONS, GRAIL_OF_PURITY
	};
	
	// Reward
	private static final int MARK_OF_LIFE = 3140;
	
	private _218_TestimonyOfLife()
        	{
		super(218);
				...
				public String onKill(Npc npc, Player killer, boolean isSummon)
        	{
					...
					else if (npcId == LETO_LIZARDMAN_SHAMAN || npcId == LETO_LIZARDMAN_OVERLORD)
					{
						if (st.getQuestItemsCount(ISAELS_INSTRUCTIONS) > 0 && st.getRandom(100) < 50)
                		{
							...
							{
							        TALINS_SPEAR_BLADE, TALINS_SPEAR_SHAFT, TALINS_RUBY, TALINS_AQUAMARINE, TALINS_AMETHYST
							})
							{
