...
public final class _279_TargetOfOpportunity extends Quest
{
	...
	private _279_TargetOfOpportunity()
	{
		super(279);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("32302-08.htm") && st.getInt("progress") == 1 && st.getQuestItemsCount(SEAL_COMPONENTS[0]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[1]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[2]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[0]) > 0)
		{
	...
	public final String onTalk(Npc npc, Player player)
	{
		...
		else if (st.getState() == State.STARTED)
		{
			...
			{
				if (st.getQuestItemsCount(SEAL_COMPONENTS[0]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[1]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[2]) > 0 && st.getQuestItemsCount(SEAL_COMPONENTS[0]) > 0)
				{
