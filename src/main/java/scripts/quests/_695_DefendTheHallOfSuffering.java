...
{
	private _695_DefendTheHallOfSuffering()
	{
		super(695);
			...
			case State.STARTED:
				switch (npc.getId())
				{
					...
					case 32530 :
						...
						if (!r.isDefault() && r.getTemplateId() == 116)
						{
	...
	private static final void finishInstance(Reflection r)
	{
		...
		final var sm = SystemMessage.getSystemMessage(SystemMessageId.INSTANT_ZONE_S1_RESTRICTED);
