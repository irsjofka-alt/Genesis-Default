...
public class _709_PathToBecomingALordDion extends Quest
{
	...
	private _709_PathToBecomingALordDion()
	{
		super(709);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		final var castle = CastleManager.getInstance().getCastleById(2);
		...
		else if (event.equals("35142-23.htm"))
		{
			...
			final var fort = FortManager.getInstance().getFort(103);
			if (fort != null)
			{
				...
				else if (fort.getContractedCastleId() != 2)
				{
					return "35142-22b.htm";
				}
			}
			final var packet = new NpcSay(npc.getObjectId(), Say2.NPC_SHOUT, npc.getId(), NpcStringId.S1_HAS_BECOME_LORD_OF_THE_TOWN_OF_DION_LONG_MAY_HE_REIGN);
