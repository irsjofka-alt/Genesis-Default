...
public class _129_PailakaDevilsLegacy extends Quest
{
	...
	private _129_PailakaDevilsLegacy()
	{
		super(129);
		...
		_allowTeleToRaid = getQuestParams(129).getBool("allowTeleToRaid");
	...
	public String onEnterZone(Creature character, ZoneType zone)
	{
		if ((character.isPlayer()) && !character.isDead() && !character.isTeleporting())
		{
			...
			if (!r.isDefault() && r.getTemplateId() == 44 && _allowTeleToRaid)
			{
				character.teleToLocation(87041, -209212, -3744, true, r);
			}
		}
