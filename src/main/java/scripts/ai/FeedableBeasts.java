...
import scripts.quests._020_BringUpWithLove;
...
public class FeedableBeasts extends AbstractNpcAI
{
	...
	public String onSkillSee(Npc npc, Player caster, Skill skill, GameObject[] targets, boolean isSummon)
	{
		...
		else if (ArrayUtils.contains(TAMED_BEASTS, npcId) && (npc instanceof TamedBeastInstance instance))
		{
			final TamedBeastInstance beast = instance;
