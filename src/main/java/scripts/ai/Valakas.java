...
public class Valakas extends Fighter
{
	...
	protected boolean createNewTask()
	{
		...
		{
			final var minion = NpcUtils.spawnSingle(29029, Location.findPointToStay(actor.getLocation(), 400, 700, false), actor.getReflection(), 0);
			_minions.add(minion);
		}
		...
		if (Rnd.chance(20))
		{
			final var r_skill = selectTopSkill(d_skill);
			if (r_skill != null)
			{
