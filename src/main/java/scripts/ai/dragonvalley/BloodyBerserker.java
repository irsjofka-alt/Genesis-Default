 ...
 */
public class BloodyBerserker extends Fighter
{
	public BloodyBerserker(Attackable actor)
	{
       		super(actor);
	}
	...
	protected void onEvtDead(Creature killer)
	{
		...
		if (killer != null)
		{
			...
			if (Rnd.chance(chance) && getActiveChar().isScriptValue(0))
			{
				...
				for (int x = 0; x < rnd; x++)
				{
					final var npc = NpcUtils.spawnSingle(22855, Location.findAroundPosition(getActiveChar(), 60, 100));
