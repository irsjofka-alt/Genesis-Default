...
import gameserver.model.actor.instance.CannibalisticStakatoChiefInstance;
...
public class StakatoNest extends Fighter
{
	...
	protected void onEvtSpawn()
	{
		...
		if (actor.getId() == QUEEN_SHYEED)
		{
			...
			for (final GameObject player : World.getAroundPlayers(actor, 1500, 400))
			{
				if (player != null)
				{
	...
	{
		final var npc = NpcUtils.spawnSingle(mobId, actor.getLocation());
		if (killer != null)
		{
