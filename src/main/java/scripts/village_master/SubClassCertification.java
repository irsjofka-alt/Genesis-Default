...
import gameserver.model.actor.instance.VillageMasterInstance;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equals("GetCertified"))
		{
			if (player.isSubClassActive())
			{
				...
				{
					if (player.getLevel() >= Config.CERT65_MIN_LEVEL)
					{
		...
		{
			final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRY_TO_RECEIVE") + " %level%-" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + " %class% " + player.getLevel() + ", %skilltype%.<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.REMEMBER") + "<br><a action=\"bypass -h Quest SubClassCertification %event%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT") + "</a><br><a action=\"bypass -h Quest SubClassCertification 9002-05.htm\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_RECEIVE_CERT") + "</a></body></html>";

			htmltext = html.replace("%level%", String.valueOf(Config.CERT65_MIN_LEVEL)).replace("%class%", Util.className(player, player.getActiveClass())).replace("%skilltype%", "" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.COMMON_SKILLS") + "").replace("%event%", "lvl65Emergent");
		}
		else if (event.equals("Obtain70"))
		{
			final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRY_TO_RECEIVE") + " %level%-" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + " %class% " + player.getLevel() + ", %skilltype%.<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.REMEMBER") + "<br><a action=\"bypass -h Quest SubClassCertification %event%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT") + "</a><br><a action=\"bypass -h Quest SubClassCertification 9002-05.htm\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_RECEIVE_CERT") + "</a></body></html>";

			htmltext = html.replace("%level%", String.valueOf(Config.CERT70_MIN_LEVEL)).replace("%class%", Util.className(player, player.getActiveClass())).replace("%skilltype%", "" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.COMMON_SKILLS") + "").replace("%event%", "lvl70Emergent");
		}
		else if (event.equals("Obtain75"))
		{
			...
			htmltext = html.replace("%level%", String.valueOf(Config.CERT75_CLASS_MIN_LEVEL)).replace("%class%", Util.className(player, player.getActiveClass())).replace("%skilltype%", "" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.SPECIAL_SKILLS") + "").replace("%event1%", "lvl75Class").replace("%event2%", "lvl75Master");
		}
		else if ("Obtain80".equals(event))
		{
			final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRY_TO_RECEIVE") + " %level%-" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + " %class% " + player.getLevel() + ", %skilltype%.<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.REMEMBER") + "<br><a action=\"bypass -h Quest SubClassCertification %event%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT") + "</a><br><a action=\"bypass -h Quest SubClassCertification 9002-05.htm\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_RECEIVE_CERT") + "</a></body></html>";

			htmltext = html.replace("%level%", String.valueOf(Config.CERT80_MIN_LEVEL)).replace("%class%", Util.className(player, player.getActiveClass())).replace("%skilltype%", "" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRANSFORM_SKILLS") + "").replace("%event%", "lvl80Class");
		}
		else if (event.startsWith("lvl"))
		{
			...
			if (type.equals("Emergent"))
			{
				...
				if (event.equals("lvl65Emergent"))
				{
					...
					{
						if (player.getLevel() > (Config.CERT65_MIN_LEVEL - 1))
						{
				...
				else if (event.equals("lvl70Emergent"))
				{
					...
					{
						if (player.getLevel() > (Config.CERT70_MIN_LEVEL - 1))
						{
							getCertified(player, COMMONITEM, "EmergentAbility" + level + prefix);
							return "9002-07.htm";
						}
			...
			else if (type.equals("Master"))
			{
				...
				{
					if (player.getLevel() > (Config.CERT75_MASTER_MIN_LEVEL - 1))
					{
			...
			else if (type.equals("Class"))
			{
				if (level == 75)
				{
					...
					if (isAvailable.equals("") || isAvailable.equals("0"))
					{
						if (player.getLevel() > (Config.CERT75_CLASS_MIN_LEVEL - 1))
						{
				...
				else if (level == 80)
				{
					...
					if (isAvailable.equals("") || isAvailable.equals("0"))
					{
						if (player.getLevel() > (Config.CERT80_MIN_LEVEL - 1))
						{
