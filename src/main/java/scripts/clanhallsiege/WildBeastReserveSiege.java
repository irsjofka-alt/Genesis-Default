...
import gameserver.model.entity.clanhall.SiegeStatus;
import gameserver.model.spawn.Spawner;
import gameserver.model.zone.type.ResidenceHallTeleportZone;
...
public final class WildBeastReserveSiege extends ClanHallSiegeEngine
{
		...
		if (event.startsWith("Register"))
		{
			...
			else
			{
				...
				if (arg.length >= 2)
				{
					...
					{
						if (player.reduceAdena(getName() + " Siege", 200000, player, true))
						{
							registerClan(clan);
							htmltext = getFlagHtml(_data.get(clan.getId()).flag);
						}
	...
	public void prepareOwner()
	{
		...
		msg.addString(_hall.getTemplate().getName(null));
	...
	private void sendRegistrationPageDate(Player player)
	{
		...
		msg.replace("%nextSiege%", TimeUtils.toSimpleFormat(_hall.getNextSiegeTime()));
	...
	public String getFlagHtml(int flag)
	{
		return switch (flag)
		{
			case 35607  -> "35627-16.htm";
			case 35608  -> "35627-17.htm";
			case 35609  -> "35627-18.htm";
			case 35610  -> "35627-19.htm";
			case 35611  -> "35627-20.htm";
			default -> "35627-15a.htm";
		};
	}
	...
	public String getAllyHtml(int ally)
	{
		return switch (ally)
		{
			case 35618  -> "35627-16a.htm";
			case 35619  -> "35627-17a.htm";
			case 35620  -> "35627-18a.htm";
			case 35621  -> "35627-19a.htm";
			case 35622  -> "35627-20a.htm";
			default -> null;
		};
	}
	...
	private final void loadAttackerMembers(int clanId)
	{
		    ...
		    Connection con = DatabaseFactory.getInstance().getConnection())
		{
			...
			{
				_log.warn(getName() + ": Tried to load unregistered clan: " + clanId + "[clan Id]");
				return;
			}
