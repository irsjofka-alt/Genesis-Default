...
import loginserver.network.communication.loginserverpackets.PingRequest;

public class GameServerConnection
{
	private static final Logger _log = LogManager.getLogger(GameServerConnection.class);
	...
	public void onDisconnection()
	{
		try
		{
			...
			if (_gameServer != null && _gameServer.isAuthed())
			{
				...
				_log.info("Gameserver ID[" + _gameServer.getHostId() + "] down.");
				_gameServer.setDown();
			}
			_gameServer = null;
		}
